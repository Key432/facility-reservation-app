  ...
  return (
    <PageLayout title='予約メニュー'>
      <div className='grid grid-cols-4 gap-4 p-4'>
        <Link href='/reservation/register' className='col-span-4 lg:col-span-2'>
          <Card title='予約登録' text='施設の予約フォーム' />
        </Link>
        <Link href='/reservation/list' className='col-span-4 lg:col-span-2'>
          <Card title='予約確認' text='施設ごとの予約状況の確認' />
        </Link>
        <Link href='/reservation/facilities' className='col-span-4 lg:col-span-2'>
